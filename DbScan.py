...
def run(X, labels_true, experiment_number, eps, minPts, samples):
    ...
    plot_text = "DBSCAN PLOT, experiment number: "  + str(experiment_number) + " Samplesize = " + \
    ...
    print("DBSCAN: ", "Experiment number ", experiment_number, " The rand index is :", rand_score, "Epsilon: ", eps, "MinPts:", minPts)
    return rand_score
